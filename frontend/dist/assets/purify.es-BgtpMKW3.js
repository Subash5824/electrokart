...
ve ||
  (ve = function (o, l) {
    for (
      var a = arguments.length, c = new Array(a > 2 ? a - 2 : 0), D = 2;
      D < a;
      D++
    )
      c[D - 2] = arguments[D];
...
const Q = {
  ...
  un = function (o, l) {
    ...
    try {
      ...
      return (
        console.warn("TrustedTypes policy " + D + " could not be created."),
        null
      );
    }
  },
...
function ht() {
    ...
    ye = function () {
      ...
      if (!(G && G === e)) {
        if (
          ...
          (be = L(e, "ALLOWED_NAMESPACES")
            ? r({}, e.ALLOWED_NAMESPACES, Ie)
            : Ut),
          (Oe = L(e, "ADD_URI_SAFE_ATTR")
            ? r(C(Ke), e.ADD_URI_SAFE_ATTR, p)
            : Ke),
          ($e = L(e, "ADD_DATA_URI_TAGS")
            ? r(C(qe), e.ADD_DATA_URI_TAGS, p)
            : qe),
          ...
          e.FORBID_CONTENTS &&
            (y === De && (y = C(y)), r(y, e.FORBID_CONTENTS, p)),
          e.ADD_FORBID_CONTENTS &&
            (y === De && (y = C(y)), r(y, e.ADD_FORBID_CONTENTS, p)),
          Re && (T["#text"] = !0),
      ...
      return be[e.namespaceURI]
        ? e.namespaceURI === se
          ...
          ? t.namespaceURI === I
            ...
            : !!Qe[n]
          : e.namespaceURI === I
          ? (t.namespaceURI === se && !ce[f]) ||
            (t.namespaceURI === re && !le[f])
            ? !1
            : !Qe[n] && (Ft[n] || !Je[n])
  ...
  const ot = function (e) {
      ...
      if (
        ...
        return N(e), !0;
      if (
        !(x.tagCheck instanceof Function && x.tagCheck(n)) &&
        (!T[n] || j[n])
      ) {
        if (
          !j[n] &&
        ...
        if (Re && !y[n]) {
          ...
          if (_ && f) {
            ...
            for (let O = m - 1; O >= 0; --O) {
              const w = Ot(_[O], !0);
              (w.__removalCount = (e.__removalCount || 0) + 1),
                f.insertBefore(w, bt(e));
            }
          }
        }
        return N(e), !0;
    ...
    rt = function (e) {
      ...
      for (; f--; ) {
        ...
        if (E !== Ce)
          try {
            O ? e.setAttributeNS(O, m, E) : e.setAttribute(m, E),
              Ne(e) ? N(e) : ft(o.removed);
          } catch {
            k(m, e);
          }
      }
  ...
  return (
    (o.sanitize = function (i) {
      ...
      if (
        (he || ye(e), (o.removed = []), typeof i == "string" && (V = !1), V)
      ) {
        if (i.nodeName) {
        ...
        (t = et("<!---->")),
          ...
          (n.nodeType === Q.element && n.nodeName === "BODY") ||
          n.nodeName === "HTML"
            ? (t = n)
            : t.appendChild(n);
      else {
        if (!F && !U && !P && i.indexOf("<") === -1)
